...
function updateLeaderboard() {
    const hardRecordsList = document.getElementById("easyRecords");
    hardRecordsList.innerHTML = "";
    ...
    records.forEach((record) => {
        ...
        hardRecordsList.appendChild(listItem);
    });
}
...
function saveRecord() {
    if (!hasAskedForName) {
        ...
        const difficultyLevel = "тяжёлый"; // Уровень сложности (в данном случае средний)
